...
private:
    ...
    */
    long findSmallestChildIndex( Edge* aValueToMove, long aIndex ) const;
    ...
    */
    void heapifyDown( Edge* aValueToMove, const long aIndex );
    ...
    * @param aIndex The current index that we're heapifying from
    */
    void heapifyUp( Edge* aValueToMove, long aIndex );
